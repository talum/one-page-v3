...
const Header = ({ siteTitle, toggleMenu, toggleSearch, searchExpanded }) => (
  <header className="header">
    <div className="header__item">
      <button
        id="js--menu-link"
        className="button button--with-svg button--small button--color-secondary"
        onClick={toggleMenu}
      >
    ...
    <div className="header__item">
      <div className="flex-container">
        ...
        <div className="flex__item">
          <button className="button button--with-svg button--small button--with-svg-hover button--color-secondary">
            <a
    ...
    C24,21,21.1,22.1,18.3,22.4z"
        ...
        <div className="flex__item">
          <button
            className="button button--with-svg button--small button--with-svg-hover button--color-secondary"
            rel="noopener noreferrer"
          >
            <a
